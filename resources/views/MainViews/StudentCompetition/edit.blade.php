...
<div class="content-wrapper" style="min-height: 798px;">
    ...
    <section class="content">
        ...
        <div class="container-fluid add-form">
            <div class="row">
                <div class="col-lg-8">
                    <form method="post" action="/dashboard/student/competition/{{ $data->id }}" class="mb-5" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        ...
                        <div class="type-group">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="leader" name="leader" autofocus value="{{ $user->name }}" disabled>
                                </div>
                                <div class="col-lg-6">
                                    <label class="d-inline word-break form-label">
                                        NIM Ketua Kelompok
                                    </label>
                                    <input type="text" class="form-control" id="leader_nim" name="leader_nim" autofocus value="{{ $user->nim }}" disabled>
                                    @error('leader_nim')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
