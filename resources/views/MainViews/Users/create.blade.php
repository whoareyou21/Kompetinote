                ...
                <div class="col-lg-8">
                    <form method="post" action="/dashboard/users" class="mb-5" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 align-items-start">
                                <input maxlength="8" type="text" class="form-control @error('nim') is-invalid @enderror" id="nim" name="nim" autofocus value="{{ old('nim') }}">
                            </div>
                            @error('nim')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 align-items-start">
                                <input type="email" class="form-control @error('personal_email') is-invalid @enderror" id="personal_email" name="personal_email" autofocus value="{{ old('personal_email') }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 d-block">
                                <input type="email" class="form-control @error('campus_email') is-invalid @enderror" id="campus_email" name="campus_email" autofocus value="{{ old('campus_email') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 align-items-start">
                                <input maxlength="16" type="text" maxlength="16" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" autofocus value="{{ old('nik') }}">
                            </div>
                            @error('nik')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 align-items-start">
                                <input type="text" class="form-control @error('account_number') is-invalid @enderror" id="account_number" name="account_number" autofocus value="{{ old('account_number') }}">
                            </div>
                        ...
                        <div class="wrp-button">
                            <button type="submit" class="btn btn-primary btn-save fleft"><i class="fa-solid fa-floppy-disk mr-2"></i> Save</button>
                        </div>
                    </form>
                </div>
            </div>
