...
<div class="content-wrapper mt-40" style="min-height: 798px;">
    <section class="content">
        <div class="container-fluid">
            <div class="row mb-3">
                <form action="/dashboard/reports" method="get" class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" name="activity_type">
                            <option value="">Semua</option>
                            <option value="Individu" {{ old('activity_type', $activity_type) == "Individu" ? 'selected' : '' }}>Individu
                            </option>
                            <option value="Kelompok" {{ old('activity_type', $activity_type) == "Kelompok" ? 'selected' : '' }}>Kelompok
                            </option>
                        </select>
                    </div>
                    <div class="col-md-2">
                        ...
                        <select class="form-select" name="achievement">
                            ...
                            <option value="Final" {{ old('achievement', $achievement) == "Final" ? 'selected' : '' }}>
                                Final</option>
                ...
                <table class="table table-striped table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center">Bukti Dokumen</th>
                            <th scope="col" class="text-center">Form Mahasiswa</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/dashboard/validations/{{ $competition->id }}/download-form" class="badge"><i class="fa-solid fa-download icon-style"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        @else
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <a class="btn btn-primary btn-filter fleft" href="/dashboard/download/reports?study_program={{ $study_program }}&semester={{ $semester }}&date={{ $date }}&activity_type={{ $activity_type }}&activity_level={{ $activity_level }}&category={{ $category }}"><i class="fa-solid fa-file-export"></i> Export Report</a>
                </div>
            </div>
        </div>
    </section>
